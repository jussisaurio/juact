...
// Helpers
export const isJuactComponent = ctor =>
  ctor &&
  ctor.prototype &&
  Object.getPrototypeOf(ctor.prototype) === Component.prototype;
export const setProp = (element, name, value) =>
  name === "children"
    ? null
    : element.setAttribute(name === "className" ? "class" : name, value);
export const removeProp = (element, name) =>
  name === "children"
    ? null
...
export const isSameHTMLType = (el, node) =>
  el.nodeName === node.type.toUpperCase();
